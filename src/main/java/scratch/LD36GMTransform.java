...
/**
 * One-shot .gmx transforms for ld36-gm
 */
public class LD36GMTransform {

    public static void main(String[] args) throws IOException {
        createTornPage("./etc/gm/ld36");
//        arrayToDsMap("./etc/gm/ld36");
    }

    public static void createTornPage(String baseDir) throws IOException {
        Scanner sc = new Scanner(new File(baseDir, "id.txt"));
        String template = FileUtils.readFileToString(new File(baseDir, "template.txt"), Charset.forName("utf-8"));
        String nums = FileUtils.readFileToString(new File(baseDir, "tornPageNumbers.txt"), Charset.forName("utf-8"));
        nums = nums.replaceAll("\r|\n", "");
    ...
    public static void arrayToDsMap(String baseDir) throws IOException {
        ...
        Scanner sc = new Scanner(new File(baseDir, "story.txt"));
        int i = 0;
        int start = 5;
        String page = "";
        String story = "";
